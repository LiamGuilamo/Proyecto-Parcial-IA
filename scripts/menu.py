...
class Menu:
    ...
    def draw(self, screen):
        ...
        # Subtítulo
        subtitle = self.font_small.render("Basado en mecánicas de Berzerk", True, GRAY)
        ...
        for i, option in enumerate(self.options):
            ...
            option_rect = option_text.get_rect(center=(self.screen_width // 2, 350 + i * 100))
